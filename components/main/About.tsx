...
const About = () => {
    return (
        <section
            id="about"
            className="flex flex-col md:flex-row relative items-center justify-center py-20 w-full h-full"
        >
            ...
            <div className="flex flex-col items-center justify-start relative md:mt-[90px] lg:mt-12 z-[20] w-auto h-auto">
                <InView triggerOnce={false}>
                    {({ inView, ref }) => (
                        ...
                        >
                            <img src="/my.png" alt="profile" width={250} />
                        </motion.div>
                    )}
                </InView>
                    ...
                    {({ inView, ref }) => (
                        ...
                        >
                            <h1 className="Welcome-text text-[16px] w-full text-justify">
                                I’m an aspiring full stack developer with a strong interest in creating simple and effective web applications.
                                I enjoy exploring new technologies and understanding how frontend and backend systems connect. Through projects and consistent learning, I’m building a solid foundation in full stack development.
                            </h1>
                        </motion.div>
                    )}
                </InView>
